...
const SignUpScreen: React.FC<SignUpScreenProps> = ({ onSwitchToLogin, translations }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-full p-4">
      <div className="w-full max-w-5xl md:grid md:grid-cols-2 lg:grid-cols-5 rounded-3xl shadow-2xl overflow-hidden glass-pane border-0">
        <div className="flex flex-col justify-center p-8 md:p-12 lg:col-span-2">
          <div className="w-full max-w-md mx-auto">
            <div className="mb-8 text-center md:text-start">
              ...
              <p className="mt-2 text-slate-600 dark:text-slate-300">{translations.signupSubtitle}</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full px-4 py-3 bg-white/50 dark:bg-slate-800/60 border border-slate-300/50 dark:border-slate-700/50 rounded-lg shadow-sm placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </div>
              <div>
        ...
        <div className="hidden md:flex flex-col items-center justify-center p-12 bg-gradient-to-br from-indigo-600 to-sky-500 lg:col-span-3 animate-background-pan bg-[length:400%_400%]">
          <div className="w-48 h-48 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm mb-8 border border-white/30">
