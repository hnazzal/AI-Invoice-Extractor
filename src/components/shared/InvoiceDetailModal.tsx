...
const InvoiceDetailModal: React.FC<InvoiceDetailModalProps> = ({ isOpen, onClose, invoice, translations, currency, language }) => {
  ...
  return (
    ...
    >
      <div 
        className="relative glass-pane max-w-4xl w-full m-4 transform transition-all flex flex-col max-h-[90vh]" 
      ...
      >
        ...
        <div className="p-6 flex-grow overflow-y-auto">
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2 pt-4 border-t border-white/20 dark:border-slate-600/50">{translations.items}</h4>
            <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-slate-200/50 dark:divide-slate-600/50">
                <thead className="bg-slate-50/20 dark:bg-slate-700/20">
                <tr>
            ...
            <div className="mt-6 pt-4 border-t border-white/20 dark:border-slate-600/50 flex justify-end">
